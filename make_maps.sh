...
python3 ./spelunca.py --width 33.7 --height 81.34 -o $OUTPUT_PATH/banner/little_coochee.svg --bounding_box $INPUT_PATH/'M2 Blue Cave_3Dpas.zip' $INPUT_PATH/'little coochie_3Dpas.zip'
echo ""
